    ...
    <section className="flex w-full bg-black xs:py-10 md:py-20 md:max-lg:h-screen md:max-lg:flex-col">
      <div className="grid flex-1 gap-2 xs:grid-cols-2 xs:grid-rows-1 xs:p-4 xs:max-md:hidden md:grid-rows-2 lg:grid-cols-4 lg:p-10">
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="h-full w-full bg-lamborghini bg-fixed bg-center bg-no-repeat"
        />
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="h-full w-full bg-lamborghini bg-fixed bg-center bg-no-repeat xs:max-md:hidden"
        />
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="h-full w-full bg-lamborghini bg-fixed bg-center bg-no-repeat xs:max-lg:hidden"
        />
        <motion.div
